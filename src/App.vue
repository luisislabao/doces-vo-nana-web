<template>
  <section   id="sec">
    ...
    <div><input type="text" placeholder=" Em nome de: *" id="name"><input type="text" placeholder="Para o endereço: *" id="addres"><input type="text" placeholder="Contato (whatsapp): *" id="contact"></div>
